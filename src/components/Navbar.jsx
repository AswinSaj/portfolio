  ...
  return (
    <div className="md:py-5 md:px-10 py-5  bg-[#040919] sticky z-10 top-0 bg-opacity-90 px-0">
      <div className="flex justify-between">
        <div>
          <h1 className="text-white text-2xl md:text-3xl font-bold md:pl-7 pl-1 hover:animate-wiggle">
            Aswin.dev
          </h1>
        </div>

        <ul className="md:flex md:gap-7 md:items-center md:w-auto  flex pl-1 items-center gap-3 text-sm md:text-base  text-white">
          <Link to="#about">
